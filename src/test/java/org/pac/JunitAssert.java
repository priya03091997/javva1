...
public class JunitAssert {
	...
	@Test
	public  void med2() throws InterruptedException {
		...
		Assert.assertEquals("verify the test", "Search Hotel (Fields marked with Red asterix (*) are mandatory)", text);
		...
		Assert.assertEquals("Verify the login page", "Select Hotel", text2);
		...
		Assert.assertEquals("verify booking page", "Book A Hotel", text3);
